...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    var Place = /*#__PURE__*/function () {
      ...
      _createClass(Place, [{
        ...
        value: function selectedElementEvents() {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_2__(place).on('dblclick', function () {
            if (place.classList.contains('selected')) {
              _this2.unselect(place, label);
            } else {
              _this2.select(place, label);
            }
          });
        }
      }, {
        ...
        value: function move() {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_2__(place).on('mousedown', function () {
            place.classList.add('active');
            jquery__WEBPACK_IMPORTED_MODULE_2__(board).off('mousemove');
            jquery__WEBPACK_IMPORTED_MODULE_2__(board).on('mousemove', function (event) {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_2__(board).on('mouseup', function () {
              jquery__WEBPACK_IMPORTED_MODULE_2__(board).off('mousemove');
    ...
    var Transition = /*#__PURE__*/function () {
      ...
      _createClass(Transition, [{
        ...
        value: function selectedElementEvents() {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_2__(transition).on('dblclick', function () {
            if (transition.classList.contains('selected')) {
              _this3.unselect(transition, label);
            } else {
              _this3.select(transition, label);
            }
          });
        }
      }, {
  ...
  function srcAppApiRepositoriesArcRepositoryTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ArcRepository = /*#__PURE__*/function () {
      ...
      _createClass(ArcRepository, [{
        ...
        key: "connectToNearestEndOfPlace",
        value: function connectToNearestEndOfPlace() {}
      }, {
        key: "connectToNearestEndOfTransition",
        value: function connectToNearestEndOfTransition() {}
      }, {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_components_board_side_menu_menu_step_one_menu_step_one_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    var _app_components_board_side_menu_menu_step_two_menu_step_two_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    ...
    var _app_components_board_side_menu_menu_step_three_menu_step_three_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    var _app_components_board_board_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_material_stepper__WEBPACK_IMPORTED_MODULE_3__["MatStepperModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_8__["BrowserAnimationsModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialogModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_5__["MatButtonModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_6__["MatSnackBarModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _app_components_dialogs_clear_board_dialog_clear_board_dialog_component__WEBPACK_IMPORTED_MODULE_0__["ClearBoardDialogComponent"], _app_components_board_side_menu_menu_step_one_menu_step_one_component__WEBPACK_IMPORTED_MODULE_9__["MenuStepOneComponent"], _app_components_board_side_menu_menu_step_two_menu_step_two_component__WEBPACK_IMPORTED_MODULE_10__["MenuStepTwoComponent"], _app_components_board_side_menu_menu_step_three_menu_step_three_component__WEBPACK_IMPORTED_MODULE_11__["MenuStepThreeComponent"], _app_components_board_board_component__WEBPACK_IMPORTED_MODULE_12__["BoardComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_material_stepper__WEBPACK_IMPORTED_MODULE_3__["MatStepperModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_8__["BrowserAnimationsModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialogModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_5__["MatButtonModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_6__["MatSnackBarModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _api_repositories_NetRepository__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ../api/repositories/NetRepository */
    "./src/app/api/repositories/NetRepository.ts");
    /* harmony import */


    var _api_helpers_BoardHelper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../api/helpers/BoardHelper */
    "./src/app/api/helpers/BoardHelper.ts");
    /* harmony import */


    var _components_dialogs_clear_board_dialog_clear_board_dialog_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var _components_board_side_menu_menu_step_one_menu_step_one_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./components/board/side-menu/menu-step-one/menu-step-one.component */
    "./src/app/app/components/board/side-menu/menu-step-one/menu-step-one.component.ts");
    /* harmony import */


    var _components_board_board_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function keyPressEventsHandler() {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_4__(document).on('keypress', function (event) {
            if (event.which === 67 || event.which == 99) {
              _this4.netRepository.createArc();
            } else if (event.which === 8 || event.which === 100) {
              _this4.deleteSelectedElements();
            }
          });
        }
      }, {
        ...
        value: function deleteSelectedElements() {
          ...
          var elements = _api_helpers_BoardHelper__WEBPACK_IMPORTED_MODULE_1__["BoardHelper"].getSelectedElements();

          var board = _api_helpers_BoardHelper__WEBPACK_IMPORTED_MODULE_1__["BoardHelper"].getBoard();
          ...
          Array.from(elements).forEach(function (element) {
            ...
            if (id[0] === 'place') {
              _this5.netRepository.placeRepository.deleteElementByID(parseInt(id[1]));
            } else if (id[0] === 'transition') {
              _this5.netRepository.transitionRepository.deleteElementByID(parseInt(id[1]));
            }
          });
        }
      }, {
        ...
        value: function openClearBoardDialog() {
          ...
          this.clearBoardDialogRef.afterClosed().subscribe(function (shouldClearBoard) {
            if (shouldClearBoard) {
              ...
              _this6.netRepository.removeAllElements();
            }
          });
        }
      }, {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("addPlace", function AppComponent_Template_app_menu_step_one_addPlace_5_listener() {
            return ctx.addPlace();
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("openClearBoardDialog", function AppComponent_Template_app_board_openClearBoardDialog_10_listener() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵsetClassMetadata"](AppComponent, [{
        ...
        return [{
          ...
          type: _api_repositories_NetRepository__WEBPACK_IMPORTED_MODULE_0__["NetRepository"],
          decorators: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Inject"],
  ...
  function srcAppAppComponentsBoardBoardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    BoardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 15,
      vars: 0,
      consts: [["id", "board"], ["id", "board-header"], [1, "material-icons", "board-button", 3, "click"], ["id", "svg-board"], ["id", "arrow", "viewBox", "0 0 10 10", "refX", "1", "refY", "5", "markerUnits", "strokeWidth", "markerWidth", "10", "markerHeight", "10", "orient", "auto"], ["d", "M 0 0 L 10 5 L 0 10 z", "fill", "black"]],
  ...
  function srcAppAppComponentsBoardSideMenuMenuStepOneMenuStepOneComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    MenuStepOneComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 34,
      vars: 0,
      consts: [[1, "card-container"], ["tabindex", "0", 1, "card", "card-small"], [1, "material-icons"], [1, "button-text"], ["title", "Create Place", 1, "square-link", 3, "click"], [1, "material-icons", "net-elements-icons"], ["title", "Create Trainsition", 1, "square-link", 3, "click"], [1, "net-elements-icons", "transition-icon"], ["title", "Create Arc", 1, "square-link", 3, "click"]],
